print( "Start of hybrid_constants.py, module-like section" )
...
print( "End of hybrid_constants.py, module-like section" )

if __name__ == "__main__":	
    print( "Start of hybrid_constants.py, script-like section" )
    ...
    print( "End of hybrid_constants.py, script-like section" )
